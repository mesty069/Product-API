            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderItemsId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    productItemOrderd_ProductItemId = table.Column<int>(type: "int", nullable: false),
                    productItemOrderd_ProductItemName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    productItemOrderd_PrictureUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
